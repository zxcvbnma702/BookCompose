...
import com.tal.xes.bookcompose.onnx.LocalDiffusionContract.BETA_SCHEDULER_LINEAR
import com.tal.xes.bookcompose.onnx.LocalDiffusionContract.BETA_SCHEDULER_SCALED_LINEAR
import com.tal.xes.bookcompose.onnx.LocalDiffusionContract.BETA_SCHEDULER_SQUARED_v2
import com.tal.xes.bookcompose.onnx.LocalDiffusionContract.PREDICTION_EPSILON
import com.tal.xes.bookcompose.onnx.LocalDiffusionContract.PREDICTION_V
import com.tal.xes.bookcompose.onnx.OrtEnvironmentManager
import com.tal.xes.bookcompose.onnx.entity.Array3D
import com.tal.xes.bookcompose.onnx.entity.LocalDiffusionConfig
import com.tal.xes.bookcompose.onnx.entity.LocalDiffusionTensor
import com.tal.xes.bookcompose.onnx.extensions.arrange
import com.tal.xes.bookcompose.onnx.extensions.interpolate
import com.tal.xes.bookcompose.onnx.extensions.lineSpace
...
internal class EulerAncestralDiscreteLocalDiffusionScheduler(
    ...
    private val env = OrtEnvironmentManager.environment
    ...
    override fun step(modelOutput: LocalDiffusionTensor<*>, stepIndex: Int, sample: LocalDiffusionTensor<*>): LocalDiffusionTensor<*> {
        ...
        return LocalDiffusionTensor(
            OnnxTensor.createTensor(env, prevSample),
            prevSample,
            modelOutput.shape
        )
    }
